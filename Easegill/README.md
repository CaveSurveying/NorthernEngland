...
components of the Lancaster Hole / Easegill system, including Pippikin.
...
imported into the spreadsheet `Easegill_statistics.ods`.

The dataset is georeferenced at the top level in
`Easegill.svx` to the OSGB 1936 British National Grid, with
EPSG code 7405.  An associated GeoPackage `Easegill.gpkg` (generated by
running `Easegill.3d` file through the QGIS3 `.3d` import filter) 
is also provided for convenience.

_Patrick B Warren, April 2015 -- October 2019 ; May 2026_
